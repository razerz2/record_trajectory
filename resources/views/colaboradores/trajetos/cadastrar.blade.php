...
@section('colaboradores.content')
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('trajetos.store') }}" method="post">
                                {{ csrf_field() }}
                                <div class="card-body">
                                    @if ($errors->any())
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="vehicleSelect" name="veiculo_id" class="form-control">
                                                    ...
                                                    @foreach ($veiculos as $veiculo)
                                                        <option value="{{ $veiculo->veiculo_id }}">{{ $veiculo->nome_veiculo }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="dataHoraRegistro" type="datetime-local" class="form-control"
                                                    value="{{ old('data_registro') }}" name="data_registro" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
    ...
    <script src="{{ asset('js/colaboradores/trajetos/cadastrar.js') }}"></script>
