                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('locais.update', ['locais' => $local->id_local]) }}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="card-body">
                                    @if ($errors->any())
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{ old('nome_local', $local->nome_local) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{ old('endereco', $local->endereco) }}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{ old('n_endereco', $local->n_endereco) }}"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="stateSelect" class="form-control" name="estado_id">
                                                    ...
                                                    @foreach($estados as $estado)
                                                        <option value="{{ $estado->id_estado }}" {{ $estado->id_estado == $local->estado_id ? 'selected' : '' }}>{{ $estado->nome_estado }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{ old('CEP', $local->CEP) }}"
